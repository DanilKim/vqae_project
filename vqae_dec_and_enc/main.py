...
def parse_args():
    ...
    parser.add_argument('--train_set', type=str, default='VQAE', choices=['VQAE', 'VQAS', 'VQAF', 'VQA2'])
    parser.add_argument('--val_set', type=str, default='VQAE', choices=['VQAE', 'VQAS', 'VQAF', 'VQA2'])
    parser.add_argument('--output', type=str, default='saved_models/trial0.2')
...
if __name__ == '__main__':
    args = parse_args()
    vocab_source = 'VQAE' #args.train_set[-4:]
    target_source = 'VQA2_2_VQAE' #vocab_source + '_2_' + args.val_set
