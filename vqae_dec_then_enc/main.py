...
def parse_args():
    ...
    parser.add_argument('--rl_train', type=bool, default=False)
    ...
    parser.add_argument('--input_exp', type=str, default='gen', choices=['gen', 'gt'])
    parser.add_argument('--output', type=str, default='saved_models/VQE_VQEA')
...
if __name__ == '__main__':
    args = parse_args()
    vocab_source = args.train_set[-4:]
    target_source = vocab_source + '_2_' + args.val_set
    args.output = args.output + '_' + args.input_exp + '_' + args.train_set
    ...
    if args.evaluate:
        ...
        train(model, train_loader, eval_loader, args.epochs, args.output, args.train_set, (args.input_exp=='gt'))
