...
def create_VQAE_explain_dictionary(dataroot, thres):
    dictionary = Dictionary()
    counter = Counter()
    files = [
...
if __name__ == '__main__':
    ...
    qd.dump_to_file('../data/VQA-X/textual/question_dictionary.pkl')
    word_cnt_thr = 5
    #cd = create_VQAE_explain_dictionary('../data', word_cnt_thr)
    cd = create_VQAX_explain_dictionary('../data/VQA-X/textual', 1)
    cd.dump_to_file('../data/VQA-X/textual/explain_dictionary.pkl')
    ...
    qd = Dictionary.load_from_file('../data/VQA-X/textual/question_dictionary.pkl')
    cd = Dictionary.load_from_file('../data/VQA-X/textual/explain_dictionary.pkl')
    ...
    #np.save('../data/VQA-X/glove6b_init_%dd_question.npy' % emb_dim, Qweights)
    #np.save('../data/VQA-X/glove6b_init_%dd_explain.npy' % emb_dim, Eweights)
    np.save('../data/VQA-X/textual/glove6b_init_%dd_question.npy' % emb_dim, Qweights)
    np.save('../data/VQA-X/textual/glove6b_init_%dd_explain.npy' % emb_dim, Eweights)
