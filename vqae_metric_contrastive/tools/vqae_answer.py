...
def filter_answers(answers_dset, min_occurence, question2qid):
    ...
    for ans_entry in answers_dset:
        ...
        occurence[gtruth].add(question2qid[(img_id, question)][0])
        ans_entry['question_id'] = question2qid[(img_id, question)].pop(0)
...
def create_ans2label(occurence, name, cache_root='../data/cache/VQAE'):
...
def compute_target(answers_dset, ans2label, name, cache_root='../data/cache/VQAE'):
...
if __name__ == '__main__':
    train_answer_file = '../data/VQA-E_train_set.json'
    train_answers = json.load(open(train_answer_file))

    val_answer_file = '../data/VQA-E_val_set.json'
    ...
    occurence = filter_answers(answers, 9, question2qid)
    ...
    compute_softscore.compute_target(val_answers, ans2label, 'val', 'data/cache/VQAE')
