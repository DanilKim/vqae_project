...
def _load_dataset(dataroot, name, answer_dir, img_id2val, thres):
    """Load entries
...
class VQAEDataset(Dataset):
    def __init__(self, name, question_dict, explanation_dict, answer_dir, dataroot='data'):
    ...
    def __getitem__(self, index):
        ...
        return features, spatials, iid, question, target, explanation, exp_len
