...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='vqe_newatt', choices=['baseline', 'vqae_newatt', 'vqe_newatt'])
    ...
    parser.add_argument('--trial', type=str, default='VQE_visualize_train')
