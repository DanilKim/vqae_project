...
from rl_finetune_generator import train as rl_ft
import utils
...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='saved_models/VQE_VQA_EQA_VQAE_1.0')
...
if __name__ == '__main__':
    ...
    if args.evaluate:
        ...
        train(model, train_loader, eval_loader, args.epochs, args.output, args.rl_train, args.temperature)
        #rl_ft(model, train_loader, eval_loader, args.epochs, args.output)
