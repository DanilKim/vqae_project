...
def parse_args():
    ...
    parser.add_argument('--A', type=str, default='saved_models/VQAE_base_model')
    parser.add_argument('--B', type=str, default='saved_models/VQAE_semi_sup_VQA2_GRU_1024_1.0')
    parser.add_argument('--A_name', type=str, default='Base')
    parser.add_argument('--B_name', type=str, default='Propo')
